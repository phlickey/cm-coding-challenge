...
export const MetaData = ({
    ...
    return showMetaData ? (
        <MetaDataContainer>
            <p>
                {' '}
                Loaded {numberOfSamples} data samples from {numberOfFiles}{' '}
                {numberOfFiles > 1 ? 'files' : 'file'}.
            </p>
            <p>
                Trip Started at{' '}
                {tripStartTime ? tripStartTime.toLocaleTimeString() : null}
            </p>
            <p>
                Trip Ended at{' '}
                {tripStartTime ? tripEndTime.toLocaleTimeString() : null}
            </p>
